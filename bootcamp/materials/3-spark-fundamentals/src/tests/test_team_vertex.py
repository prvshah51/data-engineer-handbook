...
from ..jobs.team_vertex import do_team_vertex_transformation1
...
def test_vertex_generation1(spark):
    input_data = [
    ...
    actual_df  = do_team_vertex_transformation1(spark, input_dataframe)
